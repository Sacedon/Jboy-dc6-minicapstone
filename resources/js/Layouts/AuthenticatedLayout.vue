...
<template>
  <div class="min-h-screen flex bg-gray-100 dark:bg-gray-900">
    <!-- Sidebar -->
    <aside :style="{ width: `${sidebarWidth}px`, transition: 'width 0.5s' }" class="bg-white dark:bg-blue-800 border-r border-gray-100 dark:border-gray-700">
      <!-- Resizable Button -->
  ...
  <img width="150px" src="https://images-platform.99static.com//6l5l3nfT3BoNxUAAl1DpicZiFQ8=/107x101:973x967/fit-in/500x500/99designs-contests-attachments/134/134105/attachment_134105786" alt="" style="border-radius: 50%;">
</div>
      ...
      <div class="mt-10" style="display: grid; place-content: center;">
        ...
        <NavLink v-else style="font-size: 20px;" :href="route('dashboard')">
          <div style="width: 150px;"><i class="fa-solid fa-house"></i><span style="margin-left: 10px;">Dashboard</span></div>
        </NavLink>
      ...
      <div class="mt-10" style="display: grid; place-content: center;">
        ...
        <NavLink v-else style="font-size: 20px;" :href="route('index')">
          <div style="width: 150px;"><i class="fa-solid fa-motorcycle"></i><span style="margin-left: 7px;">Motors</span></div>
        </NavLink>
