        ...
        <div class="py-12 fade-in">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <div>
                        <header style="font-size: 30px;"><i class="fa-solid fa-motorcycle"></i> Motor Management</header>
                    </div> <br>
                    <div>
                        <!-- Loop All Plugin -->
                        <div class="">
...
<div v-for="plugin in plugins" :key="plugin.id" class="mb-8">
  <div class="bg-white rounded-lg shadow-lg overflow-hidden">
    <div class="flex flex-col md:flex-row">
      <!-- Plugin Info -->
      <div class="bg-indigo-900 md:w-1/2 p-6 text-white">
        ...
        <div class="text-gray-400 mb-4">Highly Rated: {{ plugin.rating }}/5</div>
    ...
    <div class="bg-gray-200 p-6">
      ...
      <div class="md:w-1/2 bg-gray-100 p-6 flex items-center justify-center space-x-4">
  ...
  <!-- Modal Container -->
  <div class="relative bg-white dark:bg-green-800 w-96 p-6 rounded-lg shadow-lg text-gray-900 dark:text-gray-800">
    <h2 class="text-3xl font-semibold mb-6">Create Motor</h2>
    ...
    <form @submit.prevent="createPlugin">
      ...
      <!-- Model -->
      <div class="mb-4">
        <label for="daws" class="block text-sm font-medium">Model</label>
        <input
          type="text"
          id="daws"
  ...
  <!-- Modal Container -->
  <div class="relative bg-white dark:bg-green-800 w-96 p-6 rounded-lg shadow-lg text-gray-900 dark:text-gray-900">
    <h2 class="text-3xl font-semibold mb-6">Edit Motor</h2>
